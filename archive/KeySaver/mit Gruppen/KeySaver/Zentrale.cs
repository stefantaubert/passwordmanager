...
namespace WindowsFormsApplication1
{
    class Zentrale
    {
        ...
        public bool InitializeComponent(TreeView list)
        {
            ...
            bool d = _infos.Ini(Application.StartupPath + "\\key.txt");
            if (!d)
            {
        ...
        public void Suchen(string text, Color farbe, TreeView lw)
        {
        ...
        public void Remove(int index, TreeView lw)
        {
        ...
        public void Edit(int index, TreeView lw)
        {
            if (index == -1) return;
        ...
        private void SelectNode(string textparent, string textchild, TreeView _list)
        {
        ...
        public string Add(TreeView _list)
        {
        ...
        public void LoadNodes(TreeView tw)
        {
            tw.Nodes.Clear();
            for (int i = 0; i < _infos.Namen.Count; i++)
            {
